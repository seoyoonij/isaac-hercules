...
class State:
    ...
    def get_attitude_ned_frd(self):
        ...
        """
        return attitude_ned_frd_quat_from_body_to_enu(self.attitude)
    ...
    def get_linear_body_velocity_ned_frd(self):
        ...
        return linear_acceleration_to_frd_for_publish(linear_acc_body_flu)
    ...
    def get_angular_velocity_frd(self):
        ...
        """
        return angular_velocity_to_frd_for_publish(self.angular_velocity)
